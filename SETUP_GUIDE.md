...
- Phát cảnh báo nhiệt độ, thiếu sáng, bụi cao, cảm biến lỗi/mất dữ liệu.
...
| 7 | Breadboard, jumper | 1 bộ | Lắp prototype |
| 8 | Điện trở | nhiều | Hạn dòng, divider, pull-up/down |
| 9 | Tụ điện | theo mạch | 220 µF cho V-LED; 100 nF tùy chọn cho ADC/decoupling |
| 10 | USB 5 V và cáp Micro USB | 1 | Cấp nguồn/nạp firmware |
| 11 | VC830L | 1 | Kiểm tra điện áp trước khi nối ESP32 |
