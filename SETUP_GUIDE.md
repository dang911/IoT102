...
| 8 | Breadboard, jumper | 1 bộ | Lắp prototype |
| 9 | Điện trở | nhiều | Hạn dòng, divider, pull-up/down |
| 10 | Tụ điện | theo mạch | 220 µF cho V-LED; 100 nF tùy chọn cho ADC/decoupling |
| 11 | USB 5 V và cáp Micro USB | 1 | Cấp nguồn/nạp firmware |
| 12 | VC830L | 1 | Kiểm tra điện áp trước khi nối ESP32 |
