...
| 8 | Active buzzer 3,3 V/module còi chủ động | 1 | Báo quá nhiệt và phát hiện người đi vào |
...
### 5.8 Còi chủ động cảnh báo

Với module active buzzer 3 chân nhận mức logic 3,3 V:

```text
ESP32 3.3V/5V theo module ───── Buzzer VCC
GPIO26                    ───── Buzzer SIG/IN
GND chung                 ───── Buzzer GND
```

Nếu dùng còi rời hai chân hoặc còi cần dòng lớn hơn khả năng GPIO, không nối trực tiếp vào GPIO26; dùng transistor NPN/MOSFET, điện trở base/gate và diode bảo vệ nếu tải có tính cảm. Firmware mặc định dành cho **active buzzer**: GPIO chỉ bật/tắt còi, không tạo tần số âm thanh cho passive buzzer.
...
| Còi không kêu | Xác nhận là active buzzer, kiểm tra VCC/GND/SIG GPIO26 và cực tính `BUZZER_ACTIVE_HIGH` |
